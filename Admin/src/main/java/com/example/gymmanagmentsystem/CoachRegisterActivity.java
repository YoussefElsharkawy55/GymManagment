...
//        Login.setMovementMethod(LinkMovementMethod.getInstance());
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(CoachRegisterActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    public Boolean validateNameR(){
        ...
        if (val.isEmpty()) {
            ...
            Toast.makeText(CoachRegisterActivity.this, "Empty Input!", Toast.LENGTH_SHORT).show();
    ...
    public void uploadData(){
        ...
        data.child("Coaches").child(username)
                .setValue(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(CoachRegisterActivity.this, "Registered Successfully", Toast.LENGTH_SHORT).show();
                            Intent intent=new Intent(CoachRegisterActivity.this,CoachesManageActivity.class);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(CoachRegisterActivity.this, "Failed To Register", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
